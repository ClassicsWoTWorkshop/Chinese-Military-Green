...
To install:
- Drag the "CWW-RecolorPack-Chinese-MilitaryGreen" folder from the included "MAIN MOD (Install this FIRST)" folder to your "mods" folder within the World of Tanks install directory (by default, C:\Games\World_of_Tanks\mods\<version>) (example: C:\Games\World_Of_Tanks\mods\1.2.0.1).
